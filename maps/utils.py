...
def key_of_min_value(d):
    ...
    """
    # BEGIN Question 0
    return min(d, key = lambda x: d[x]) #the key function can return the value 
    # END Question 0
...
def enumerate(s, start=0):
    ...
    # BEGIN Question 0
    "*** YOUR CODE HERE ***"
    return zip(range(start, len(s) + start), s)   # need to create a second list containing the index starting from "start"
