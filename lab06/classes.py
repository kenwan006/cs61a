...
class Player(object):
    ...
    def go_to(self, location):
        ...
        if destination_place.locked:
            ...
            self.place = destination_place  # once the destination is not locked, then go to that place
    ...
    def take(self, thing):
        ...
        if type(thing) != str:
            ...
            self.backpack.append(self.place.things[thing])  # put the Thing into backpack
            self.place.things.pop(thing)  # remove the thing if it is taken
