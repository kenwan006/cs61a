...
def div_interval(x, y):
    ...
    reciprocal of y."""
    "*** YOUR CODE HERE ***"
    assert x != 0 and y != 0, 'zero cannot be taken as divider'
...
def check_par():
    ...
    True
    """
    r1 = interval(1, 2) # Replace this line! change from (1,1) to (1,2)
    r2 = interval(1, 2) # Replace this line! change from (1,1) to (1,2)
    return r1, r2
...
def quadratic(x, a, b, c):
    ...
    x1, x2, x3 = lower_bound(x), upper_bound(x), -b/(2*a)
    p1, p2, p3 = f(x1), f(x2), f(x3)

    if x1 < x3 < x2: # to check if the extreme point sits within the range
